      ...
      <aside style="margin-top: 46px" id="sidebar" class="sidebar">
            ...
            <main style="margin-top: 4px" id="main" class="main">
                ...
                <section class="section contact">
                    <div>
                        <div class="card p-4">
                            <form action="editchapter?chapterid=${chapterid}&bookID=${bookID}" method="post" onsubmit="return validateForm()">
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    Chương số 
                                    ...
                                    <div class="col-md-12" >
                                        Tên chương
                                        <textarea class="form-control" name="namechapter" id="namechapter" rows="1"required >${chapternumber.chaptername}</textarea>
                                    ...
                                    <div class="col-md-12" >
                                        Nội dung
                                        <textarea class="form-control" name="content" id="content" rows="10" minlength="100" required>${chapternumber.content_1}  ${chapternumber.content_2}</textarea>
