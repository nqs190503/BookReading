...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
              content="  truyện một cách nhanh nhất.">
    </head>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    <c:forEach items="${category}" var="ca">
                                        <li><a class="dropdown-item" href="category.html">${ca.catename}</a>
                                        </li>
                                    </c:forEach>
                            ...
                            <c:if test="${user!=null}">
                                <a class="nav-link" role="button" aria-expanded="false" href="logout">
                                    Logout
                                </a>
                            </c:if>
                        </ul>
                        ...
                        <form class="d-flex header__form-search" action="search" method="post">
                            <input class="form-control search-story" type="text" placeholder="Tìm kiếm" name="searchs" >
                        ...
                        <div class="form-check form-switch me-3 d-flex align-items-center">
                            ...
                            <label class="form-check-label">
                                <a class="nav-link" role="button"   aria-expanded="false" href="profileacc.jsp">
                                    <!-- Thêm thẻ link để tải FontAwesome -->
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mb-3">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-custom">
                                        <c:forEach items="${category}" var="ca">
                                            <li><a class="dropdown-item" href="#">${ca.catename}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </li>
                            ...
                            <div class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                <h2 class="me-2 mb-0 border-bottom border-secondary pb-1">
                                    <a href="#" class="d-block text-decoration-none text-dark fs-4 story-name"
                                       title="Truyện Hot">Truyện Tìm Kiếm</a>
                                </h2>
                                    ...
                                    <div class="section-list-category bg-light p-2 rounded card-custom">
                                        ...
                                        <div class="row">
                                            ...
                                            <ul class="list-gory">
                                                <c:forEach items="${category}" var="ca">
                                                    <li class="">
                                                        <a href="#" class="text-decoration-none text-dark hover-title">${ca.catename}</a>
                                                    </li>
                                                </c:forEach>
